...
AS
BEGIN
    EXEC tSQLt.ExpectException 'tSQLt.AssertNotEquals failed. Expected any value except:<hello>.';
...
AS
BEGIN
    EXEC tSQLt.ExpectException 'Error message. tSQLt.AssertNotEquals failed. Expected any value except:<hello>.';
...
AS
BEGIN
    EXEC tSQLt.ExpectException 'tSQLt.AssertNotEquals failed. Expected any value except:<(null)>.';
...
AS
BEGIN
    EXEC tSQLt.ExpectException 'tSQLt.AssertNotEquals failed. Expected any value except:<5>.';
...
AS
BEGIN
    EXEC tSQLt.ExpectException 'tSQLt.AssertNotEquals failed. Expected any value except:<3.14>.';
