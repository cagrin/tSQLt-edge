...
# tSQLt-edge
tSQLt-compatible unit testing framework for SQL Server 2019, 2022 and 2025. It is available as a [nuget package](https://www.nuget.org/packages/tSQLt.Edge) and works perfectly with [MSBuild.SDK.SqlProj](https://github.com/rr-wfm/MSBuild.Sdk.SqlProj) project format.
